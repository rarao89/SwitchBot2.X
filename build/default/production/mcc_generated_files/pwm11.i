...
# 58 "mcc_generated_files/pwm11.c"
void PWM11_Initialize(void)
{
...
void PWM11_PhaseSet(uint16_t phaseCount)
{
PWM11PHH = (phaseCount>>8);
PWM11PHL = (phaseCount);
}

void PWM11_DutyCycleSet(uint16_t dutyCycleCount)
{
PWM11DCH = (dutyCycleCount>>8);
PWM11DCL = (dutyCycleCount);
}

void PWM11_PeriodSet(uint16_t periodCount)
{
PWM11PRH = (periodCount>>8);
PWM11PRL = (periodCount);
}

void PWM11_OffsetSet(uint16_t offsetCount)
{
PWM11OFH = (offsetCount>>8);
PWM11OFL = (offsetCount);
}
